...
import "./App.css";
import vote_program from "../helloworld/build/main.aleo?raw";
...
function App() {
  ...
  async function execute() {
    ...
    const result = await aleoWorker.localProgramExecution(
      vote_program,
      "propose",
      ["{title:'Are you sleeping?','content':'no','proposer':'aleo14f08xhcf575gq5f2glgmx9rwx0002f4s9gzh55cvqste2k0xagzqckxza4'}"],
    );
    setExecuting(false);
  ...
  async function deploy() {
    setDeploying(true);
    try {
      const result = await aleoWorker.deployProgram(vote_program);
