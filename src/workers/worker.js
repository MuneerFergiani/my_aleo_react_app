...
async function deployProgram(program) {
  ...
  const account = new Account({
    privateKey: "APrivateKey1zkpHjGxdt4SdAdkV55FmrTGme3YzKWw5gBXEeHT1oyCZUce",
  });
...
const workerMethods = { networkProgramExecution, localProgramExecution, getPrivateKey, deployProgram };
